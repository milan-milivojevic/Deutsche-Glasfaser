...
function CarouselTeaser ({
  ...
  const href = multi['multi' + currentIndex]?.linkType === "page" ? (getRouterBasename() + multi['multi' + currentIndex]?.page).replace("//", "/").replace("Landing/Landing", "Landing") : multi['multi' + currentIndex]?.linkType === "external" ? multi['multi' + currentIndex]?.external : downloadLink;
