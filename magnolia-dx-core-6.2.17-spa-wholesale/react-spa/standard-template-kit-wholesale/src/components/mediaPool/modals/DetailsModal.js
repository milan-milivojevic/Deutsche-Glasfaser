...
const DetailsModal = (props) => {
  ...
  const linkPath = `${baseURL}${apiBase}/Wholesale/Search-Pages/MP-Search?query=M-${assetId}`;
          ...
          <div className='detailsModal'>
            ...
            <div className='detailsModalContent'>
              <div className='detailsModalInfo'>
                ...
                {description &&
                  <p className='assetDescription'><span>Beschreibung: </span>{description}</p>
                }
                <p><span>Asset ID: </span>{assetId}</p>
                <p><span>Eigentümer: </span>{owner}</p>
                <p><span>Dateigröße: </span>{fileSize}</p>
                <p><span>Virtuelle DB: </span>{vdb}</p>
                <p><span>Upload-Datum: </span>{uploadDate}</p>
                <p><span>Letzte Änderung: </span>{lastUpdatedTime}</p>
                {/* {keywords &&
                  <p><span>Keywords: </span>{keywords}</p>
                } */}
                {assetTags &&
                  <p><span>Kategorien: </span>{assetThemes}</p>
                }
                {assetTags &&
                  <p><span>Tags: </span>{assetTags}</p>
                }
                {linkToW2P &&
                  <p><span>Link zum W2P: </span><a className='linkToW2P' href={linkToW2P}>{linkToW2P}</a></p>
                }
              </div>
