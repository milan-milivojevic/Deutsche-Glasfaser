...
function HeadlinesStyles() {  
  ...
  const pFontSize = configProps?.pFontSize || "";
  const pFontFamily = configProps?.pFontFamily || "";
  const pBold = configProps?.pBold || "";
  const pItalic = configProps?.pItalic || "";
  const pLetterSpacing = configProps?.pLetterSpacing || "";
  const pColor = configProps?.pColor || "";
  const pLineHeight = configProps?.pLineHeight || "";
  const pTextTransform = configProps?.pTextTransform || "";
  const pPaddingTop = configProps?.pPaddingTop || "";
  const pPaddingBottom = configProps?.pPaddingBottom || "";
  const pPaddingLeft = configProps?.pPaddingLeft || "";
  const pPaddingRight = configProps?.pPaddingRight || "";

  const pSmallFontSize = configProps?.pSmallFontSize || "";
  const pSmallFontFamily = configProps?.pSmallFontFamily || "";
  const pSmallPosition = configProps?.pSmallPosition || "";
  const pSmallBold = configProps?.pSmallBold || "";
  const pSmallItalic = configProps?.pSmallItalic || "";
  const pSmallLetterSpacing = configProps?.pSmallLetterSpacing || "";
  const pSmallColor = configProps?.pSmallColor || "";
  const pSmallLineHeight = configProps?.pSmallLineHeight || "";
  const pSmallTextTransform = configProps?.pSmallTextTransform || "";
  const pSmallPaddingTop = configProps?.pSmallPaddingTop || "";
  const pSmallPaddingBottom = configProps?.pSmallPaddingBottom || "";
  const pSmallPaddingLeft = configProps?.pSmallPaddingLeft || "";
  const pSmallPaddingRight = configProps?.pSmallPaddingRight || "";
  ...
  return (
    <GlobalStyles 
      ...
      pTextTransform={pTextTransform}
      pPaddingTop={pPaddingTop}
      pPaddingBottom={pPaddingBottom}
      pPaddingLeft={pPaddingLeft}
      pPaddingRight={pPaddingRight}
